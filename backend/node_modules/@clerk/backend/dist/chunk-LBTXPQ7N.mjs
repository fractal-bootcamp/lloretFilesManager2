...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"1.5.0"}`;
    ...
    if (authenticateContext.handshakeToken) {
      try {
        ...
        if (error instanceof TokenVerificationError) {
          ...
          if (error.reason === TokenVerificationErrorReason.TokenInvalidSignature || error.reason === TokenVerificationErrorReason.InvalidSecretKey) {
            return signedOut(
              authenticateContext,
...
//# sourceMappingURL=chunk-LBTXPQ7N.mjs.map